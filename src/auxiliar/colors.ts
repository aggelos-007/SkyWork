...
export default {
    reset, bright, dim, underscore, blink, reverse, hidden, black, red, green, yellow, blue, magenta, cyan, white, BGblack, BGred, BGgreen, BGyellow, BGblue, BGmagenta, BGcyan, BGwhite,
    FrameWork: `${yellow + dim}[${reset + magenta}SkyWork${yellow + dim}]${reset + white}`
}